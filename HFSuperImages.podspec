...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mjohnsonpqa/HFSuperImages'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mjohnsonpqa' => 'michelle.johnson@pqa.ca' }
  s.source           = { :git => 'https://github.com/mjohnsonpqa/HFSuperImages.git', :tag => s.version.to_s }
